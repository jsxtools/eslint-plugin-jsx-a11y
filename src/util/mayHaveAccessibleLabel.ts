...
import type { JSXOpeningElement, JSXExpressionContainer } from 'estree-jsx';
import type { BaseNode } from 'estree';

import { getPropValue, propName } from './module/jsx-ast-utils.ts';
...
function hasLabellingProp(
  ...
  const labellingProps = ([] as string[]).concat(
